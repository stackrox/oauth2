...
func PostRawRequest(ctx context.Context, clientID, clientSecret, tokenURL string, v url.Values, authStyle AuthStyle, styleCache *AuthStyleCache) (*http.Response, error) {
...
func RetrieveToken(ctx context.Context, clientID, clientSecret, tokenURL string, v url.Values, authStyle AuthStyle, styleCache *AuthStyleCache) (*Token, error) {
	resp, err := PostRawRequest(ctx, clientID, clientSecret, tokenURL, v, authStyle, styleCache)
	if err != nil {
		return nil, err
	}
